    ...
    <div className="min-h-screen bg-[#f8fafc] py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col sm:flex-row gap-4 mb-10">
          ...
          <Link
            to="/instructor/courses"
            className="flex-1 sm:flex-none bg-white text-slate-700 px-8 py-4 rounded-2xl border-2 border-slate-100 hover:border-indigo-200 hover:bg-indigo-50 transition-all font-bold shadow-sm flex items-center justify-center gap-3 group"
          >
        ...
        <div className="bg-white rounded-3xl shadow-sm border border-slate-100 p-8">
          <div className="flex items-center justify-between mb-8">
            <div>
              ...
              <p className="text-sm text-slate-500 mt-1">Manage and edit your course content</p>
            </div>
            {courses.length > 5 && (
              <Link
                to="/instructor/courses"
  ...
  return (
    ...
    >
      ...
      <div className="flex-1 w-full">
        <h3 className="font-bold text-slate-900 mb-3 text-lg group-hover:text-indigo-600 transition-colors">
          {course.title}
        </h3>
      ...
      <div className="flex sm:flex-col items-center sm:items-end gap-4 w-full sm:w-auto">
        <div className="text-left sm:text-right flex-1 sm:flex-none">
          <p className="text-2xl font-black text-indigo-600">{formatPrice(course.price)}</p>
